...
export const SEED_ROUTES = [
  {
    ...
    startCoords: { lat: 48.2883, lon: 8.3879 },
    endCoords: { lat: 48.2906, lon: 8.3434 },
    loop: true,
    lengthKm: 18,
    durationMin: 75,
    elevationM: 180,
  ...
  },
  {
    ...
    startCoords: { lat: 48.2997, lon: 8.2186 },
    endCoords: { lat: 48.2997, lon: 8.2186 },
    loop: true,
    lengthKm: 32,
    durationMin: 150,
    elevationM: 620,
  ...
  },
  {
    ...
    startCoords: { lat: 48.2814, lon: 8.1791 },
    endCoords: { lat: 48.4042, lon: 8.0142 },
    loop: false,
    lengthKm: 38,
    durationMin: 160,
    elevationM: 120,
  ...
  },
  {
    ...
    startCoords: { lat: 48.2883, lon: 8.3879 },
    endCoords: { lat: 48.4753, lon: 8.2898 },
    loop: false,
    lengthKm: 28,
    durationMin: 180,
    elevationM: 900,
